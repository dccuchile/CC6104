...
\scriptsize{
\begin{itemize} 
 \item Now using data generated with a thiner-tailed Beta distribution with hyperparameters $5,5$:
...
[1] 2.1046
 ...
 \item  As expected we get a negative excess kurtosis (i.e. less than 3) since the distribution has thiner tails (Platykurtic). 
