...
\begin{itemize}
 ...
 \scriptsize{
   \item  \textbf{Mesokurtic}: This is the normal distribution (kurtosis $\approx 3$)
    \item \textbf{Leptokurtic}: This distribution has fatter tails than a normal distribution (kurtosis $> 3$). Consequently, outliers are more likely to occur than in a normal distribution.
