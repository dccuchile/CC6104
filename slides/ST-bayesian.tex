...
\item For any positive integer (such as W and L) $\Gamma(n) = (n-1)!$
...
\begin{frame}[fragile]{A Globe Model}
\scriptsize{

\begin{itemize}
\item Let's build our posterior:
\begin{displaymath}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.2]{pics/wolphram.png}
\end{figure}
