...
\item Let index our conjecture with a parameter $\theta$ defined as the number of marbles that are blue:  $\theta=1 \rightarrow$ \includegraphics[scale=0.3]{pics/marbles14.png}, $\theta=2 \rightarrow$ \includegraphics[scale=0.3]{pics/marbles14.png}, $\theta=3 \rightarrow$ \includegraphics[scale=0.3]{pics/marbles14.png}, $\theta=4 \rightarrow$ \includegraphics[scale=0.3]{pics/marbles14.png}.
\item The main differente
...
\item The denominator can be expressed by the law of total probabilities as 
\begin{equation}
...
\end{itemize}
 ...
 \begin{tabular}{ccccc}
$\theta$ & $P(\theta)$ & Ways to Produce Data & $P(d|\theta)$ & $P(\theta|d) = P(d|\theta)*P(\theta) / P(d)$ \\
0 & 1/5 & 0 & 0/64 & 1/5*0/64 / 0.0625 =0 \\
1 & 1/5 & 3 & 3/64 & 1/5*3/64 / 0.0625 = 0.15
\\
2 & 1/5 & 8 & 8/64 & 1/5*8/64 / 0.0625 = 0.4 \\
3 & 1/5 & 9 & 9/64 & 1/5*9/64 / 0.0625 = 0.45 \\
4 & 1/5 & 0 & 0/64 & 1/5*0/64 / 0.0625 = 0 \\
\end{tabular} 
 
P(d)= 1/5 * 0/64 + 1/5*3/64 + 1/5*8/64+1/5*9/64+1/5*0/64 = 0.0625 
\end{frame}
