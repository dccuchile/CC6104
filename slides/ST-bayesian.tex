...
\item  The hyper-parameters of our prior, for example $\alpha$ and $\beta$ for a Beta prior can be seen as ``pseudo-counts'' of successes and failures before collecting the data.  
...
\item Various numerical techniques are needed to approximate the mathematics that follows from the definition of the posterior.

\item The most popular ones are the following:
