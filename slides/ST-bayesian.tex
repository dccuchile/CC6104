...
\begin{itemize}
 \item Quadratic approximation is implemented in function \textbf{quap} from the \textbf{rethinking} R package.
...
\begin{itemize}
\item There are lots of important model types, like multilevel (mixed-effects) models, where quadratic approximation doesn't work.
