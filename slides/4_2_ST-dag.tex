...
\item A path from q to r is d-connecting with respect to the evidence nodes E if every interior node $n$ in the undirected path has the property that either
