...
\begin{frame}{Point Estimation  (5)}
\scriptsize{
\begin{itemize}
...
\item There are two common estimators, a biased version  \begin{displaymath}
 s_{n}^{2}= \frac{1}{n} \sum_{i}^{n}(X_{i}-\overline{X_{n}})^2
\end{displaymath}

\item An unbiased version \begin{displaymath}
 s^{2}= \frac{1}{n-1} \sum_{i}^{n}(X_{i}-\overline{X_{n}})^2
\end{displaymath}

\item When we do not know the variance of the population and want to estimate the mean, the standard error is estimated: \begin{displaymath}                                                                                                                 
...
\begin{frame}{Point Estimation (6)}
\scriptsize{
\begin{itemize}
...
\begin{frame}{Point Estimation (7)}
...
\begin{frame}{Point Estimation (8)}
